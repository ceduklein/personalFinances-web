...
function TableSort(props) {
  ...
  return(
    <DataTable value={props.data}
      ...
      <Column field="month" header="Mês" body={formatMonth} style={{width: '10%'}} sortable />
      <Column field="year" header="Ano"  style={{width: '8%'}}sortable />
      <Column field="status" header="Situação" style={{width: '12%'}} sortable />
      <Column body={actionbodyTemplate} header="Ação" style={{width: '29%'}} />
    </DataTable>
  )
}
